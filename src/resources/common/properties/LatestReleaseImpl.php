...
class LatestReleaseImpl extends XMLNode implements LatestRelease{
    ...
    public function getDate(){
        $value=$this->xpath("/prop:latest-release/release:date");
    ...
    public function getNumber(){
        $value=$this->xpath("/prop:latest-release/release:number");
