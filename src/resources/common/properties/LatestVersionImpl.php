...
class LatestVersionImpl extends XMLNode implements LatestVersion{
    ...
    public function getDate(){
        $value=$this->xpath("/prop:latest-version/version:date");
    ...
    public function getNumber(){
        $value=$this->xpath("/prop:latest-version/version:number");
